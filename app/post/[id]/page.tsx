  ...
  const posts = [
    {
      ...
      sessionInfo: {
        ...
        author: "자작 시나리오",
        playerCount: 3,
        overview: "현대 일본의 어느 도시에서 벌어지는 닌자들의 이야기. 각자의 사명을 가진 닌자들이 하나의 사건에 얽히게 되면서 시작되는 모험",
        characters: [
          {
            name: "카게마루",
            player: "타로",
        ...
        highlight: "벚꽃이 흩날리는 봄밤, 세 명의 닌자가 도쿄의 네온사인 아래에서 만났다. 각자 다른 사명을 가지고 있었지만, 운명은 그들을 하나의 길로 이끌었다. 현대와 전통이 교차하는 이 도시에서, 그들만이 알 수 있는 진실이 기다리고 있었다."
      },
      subPosts: [
        {
          id: "session-1",
          ...
          content: [
            ...
            },
            {
              id: 11,
              type: 'system' as const,
              content: '류진의 말에 카페의 분위기가 순간 긴장감으로 바뀌었다. 다른 손님들은 여전히 평범한 대화를 나누고 있었지만, 이 세 사람 사이에는 다른 공기가 흘렀다.'
            },
            {
              id: 12,
              type: 'character' as const,
            ...
            },
            {
              id: 18,
              type: 'system' as const,
              content: '이때 카페 밖으로 검은 정장을 입은 수상한 남자들이 지나가는 것이 보였다. 세 닌자 모두 그들의 존재를 눈치챘다.'
            },
            {
              id: 19,
              type: 'ooc' as const,
