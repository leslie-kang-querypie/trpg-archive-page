              ...
              {isEditing ? (
                <div className='space-y-2'>
                  ...
                  <div className='flex gap-2'>
                    <Button size='sm' onClick={() => saveEdit(actualIndex)}>
                      저장
                    </Button>
...
export default function EditPage() {
  ...
  // 단계 관련 상태
  const [currentStep, setCurrentStep] = useState<'upload' | 'select' | 'edit'>(
    'upload'
  );
                          ...
                          {selectedLogType === 'dice' && (
                            <>
                              ...
                              <div>
                                ...
                                <Input
                                  value={
                                    newEntryData.diceResult?.rolls?.join(
                                      ', '
                                    ) || ''
                                  }
                                  onChange={e =>
                          ...
                          {selectedLogType === 'damage' && (
                            <>
                              ...
                              <div>
                                ...
                                <Select
                                  value={
                                    newEntryData.damageInfo?.type || 'damage'
                                  }
                                  onValueChange={value =>
                                    setNewEntryData(prev => ({
                                      ...prev,
                          ...
                          {selectedLogType === 'handout' && (
                            <>
                              ...
                              <div>
                                ...
                                <Input
                                  value={
                                    newEntryData.handoutInfo?.category || ''
                                  }
                                  onChange={e =>
                                    setNewEntryData(prev => ({
                                      ...prev,
                              ...
                              <div className='flex items-center space-x-2'>
                                <Checkbox
                                  id='is-secret'
                                  checked={
                                    newEntryData.handoutInfo?.isSecret || false
                                  }
