...
const posts = [
  {
    ...
    summary:
      '레벨 1-11 캠페인의 첫 번째 세션. 파티가 고블린 소굴을 발견하고...',
    ...
    sessionInfo: {
      ...
      playerCount: 4,
      overview:
        '신참 모험가들이 마을 근처의 고블린 문제를 해결하며 첫 모험을 시작하는 이야기',
      characters: [
        {
          name: '실바나스',
          player: '민수',
      ...
      highlight:
        "황금빛 석양이 마을을 물들이던 그 저녁, 네 명의 낯선 이들이 '황금 용' 여관에서 만났다. 멜로디의 유쾌한 웃음소리가 여관을 가득 채우고, 그림의 묵직한 발걸음이 바닥을 울렸다. 실바나스는 그림자 속에서 조용히 상황을 관찰했고, 핀은 작은 손으로 마법서의 페이지를 넘기며 미소를 지었다. 운명이 그들을 하나로 엮어낸 그 순간, 아무도 이것이 전설의 시작이 될 줄은 몰랐다.",
    },
  },
  {
    id: 2,
    ...
    summary:
      '1920년대 배경의 호러 시나리오. 조사관들이 인스머스 마을에 도착하여...',
    ...
    sessionInfo: {
      ...
      playerCount: 3,
      overview:
        '1920년대 뉴잉글랜드의 어촌 마을 인스머스에서 벌어지는 기괴한 사건들을 조사하는 이야기',
      characters: [
        {
          name: '존 워커',
          player: '철수',
      ...
      highlight:
        '안개가 자욱한 인스머스 항구에 도착한 세 명의 조사관들. 바다에서 들려오는 기이한 소리와 마을 사람들의 시선이 그들을 따라다녔다. 존의 예리한 직감이 위험을 감지했고, 메리는 고대 유물에서 느껴지는 불길한 기운에 몸서리쳤다. 토마스는 펜을 든 손이 떨렸지만, 진실을 밝혀내야 한다는 사명감으로 마음을 다잡았다.',
    },
  },
  {
    id: 3,
    ...
    sessionInfo: {
      ...
      highlight:
        '네온사인이 빗물에 반사되는 나이트 시티의 밤. 네 명의 아웃사이더들이 어둠 속에서 만났다. 잭의 차가운 눈빛에는 복수의 불꽃이 타올랐고, 네온의 손끝에서는 전자의 춤이 펼쳐졌다. 크롬은 기계와 인간의 경계를 넘나들며, 바이퍼는 자유로운 영혼으로 길 위의 진실을 추구했다. 거대한 기업의 그림자가 드리운 도시에서, 그들만이 마지막 희망이었다.',
    },
  },
  {
    id: 4,
    ...
    sessionInfo: {
      ...
      playerCount: 3,
      overview:
        '대재앙 이후 황폐해진 세계에서 희망을 찾아 나서는 영웅들의 이야기',
      characters: [
        {
          name: '아샤',
          player: '민지',
      ...
      highlight:
        '재로 뒤덮인 하늘 아래, 세 명의 생존자가 폐허 속에서 서로를 발견했다. 아샤의 예언적 시야는 어둠 속에서도 희망의 빛을 찾아냈고, 카이의 원시적 힘은 절망을 분쇄했다. 루나는 황무지의 흔적을 읽으며 살아남을 길을 찾았다. 세상이 끝났다고 여겨지는 그 순간에도, 그들의 마음속에는 새로운 시작을 향한 불꽃이 꺼지지 않았다.',
    },
  },
];
