...
export default function WritePage() {
  ...
  const addSubPost = () => {
    ...
    setSubPosts([
      ...subPosts,
      { id: newId, title: '', description: '', content: '' },
    ]);
  };
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
                    ...
                    <div className='space-y-2'>
                      ...
                      <Input
                        ...
                        onChange={e =>
                          updateCharacter(index, 'player', e.target.value)
                        }
                        placeholder='예: 민수'
                        required
                      />
                    ...
                    <div className='space-y-2'>
                      ...
                      <Input
                        ...
                        onChange={e =>
                          updateCharacter(index, 'class', e.target.value)
                        }
                        placeholder='예: 엘프 로그'
                        required
                      />
                    ...
                    <div className='space-y-2'>
                      ...
                      <Input
                        ...
                        onChange={e =>
                          updateCharacter(index, 'thumbnail', e.target.value)
                        }
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                각 세션별로 로그를 작성해주세요. 비밀번호를 입력한 사용자만 볼
                수 있습니다.
              </CardDescription>
            </CardHeader>
                  ...
                  <div className='space-y-3'>
                    <div className='space-y-2'>
                      ...
                      <Input
                        value={subPost.title}
                        onChange={e =>
                          updateSubPost(index, 'title', e.target.value)
                        }
                    ...
                    <div className='space-y-2'>
                      ...
                      <Input
                        ...
                        onChange={e =>
                          updateSubPost(index, 'description', e.target.value)
                        }
                    ...
                    <div className='space-y-2'>
                      ...
                      <div className='text-xs text-muted-foreground mb-2 p-3 bg-muted/50 rounded'>
                        ...
                        <br />• <strong>내레이션:</strong> 상황 설명 (따옴표
                        없이)
                        <br />
                        <br />
                        <strong>예시:</strong>
                      ...
                      <Textarea
                        ...
                        onChange={e =>
                          updateSubPost(index, 'content', e.target.value)
                        }
