        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                각 세션별로 로그를 작성해주세요. 비밀번호를 입력한 사용자만 볼 수 있습니다.
              </CardDescription>
            </CardHeader>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-xs text-muted-foreground mb-2 p-3 bg-muted/50 rounded">
                        <strong>대본 형식 작성 가이드:</strong><br/>
                        • <strong>대화:</strong> 캐릭터명: "대사 내용"<br/>
                        • <strong>액션:</strong> *행동 설명*<br/>
                        • <strong>내레이션:</strong> 상황 설명 (따옴표 없이)<br/><br/>
                        <strong>예시:</strong><br/>
                        황금빛 석양이 마을을 물들이던 저녁...<br/>
                        *실바나스가 구석 테이블에 조용히 앉는다.*<br/>
                        멜로디: "안녕하세요, 모든 분들!"
                      </div>
                      <Textarea
...
예시:
황금빛 석양이 마을을 물들이던 저녁, 황금 용 여관은 사람들로 북적였다.

*실바나스가 구석 테이블에 조용히 앉아 다른 손님들을 관찰하고 있다.*

멜로디: \"안녕하세요, 모든 분들! 오늘도 좋은 하루 보내셨나요?\"

*그림이 맥주잔을 내려놓으며 중얼거린다.*
